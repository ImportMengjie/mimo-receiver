...
if __name__ == '__main__':
    ...
    model = DetectionNetModel(csi_dataloader.n_r, csi_dataloader.n_t, 16, True, modulation='qpsk', is_training=False)
    ...
    nmse_dict, x = analysis_detection(csi_dataloader, detection_methods, 0, 250)
