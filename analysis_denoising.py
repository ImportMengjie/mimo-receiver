...
if __name__ == '__main__':
    ...
    csi_dataloader = CsiDataloader('data/spatial_64_32_64_100.mat', train_data_radio=0.9, factor=1)
    ...
    detection_methods = [DenoisingMethodMMSE(), DenoisingMethodLS(), DenoisingMethodIdealMMSE()]

    nmse_dict, x = analysis_denoising(csi_dataloader, detection_methods, 0, 30, 1)
