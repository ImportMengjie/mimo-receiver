...
def get_freq_h(N_r_v, N_r_h, N_t, K, L_range: list, low_freq, sc_band, arrayant: Arrayant):
...
def spatial_mu_generate(N_r, N_t, K, J, L_range, low_freq, sc_band, arrayant: Arrayant):
    ...
    H_list = []
    for j in range(J):
        H = get_freq_h(N_r_v, N_r_h, N_t, K, L_range, low_freq, sc_band, arrayant)
...
if __name__ == '__main__':
    ...
    H = spatial_mu_generate(N_r, N_t, K, J, L_range, low_freq, sc_band, arrayant)
